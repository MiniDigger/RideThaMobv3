...
public class GenClasses {
    ...
    private static final File f = new File( "v1_8_R3/src/main/java/me/MiniDigger/RideThaMob/v1_8_R3/entities" );
    private static final File orig = new File( new File( "v1_8_R3/src/main/java/me/MiniDigger/RideThaMob/v1_8_R3" ), "RideAbleEntity.java" );
        ...
        while ( s.hasNextLine() ) {
            w.println( s.nextLine().replace( "EntitySkeleton", "Entity" + file.getName().replace( ".java", "" ).replace( "RideAble", "" ) )
                    .replace( "RideAbleEntity", file.getName().replace( ".java", "" ) ).replace( "%date%", new SimpleDateFormat().format( new Date() ) ).
                            replace( "package me.MiniDigger.RideThaMob.v1_8_R3;", "package me.MiniDigger.RideThaMob.v1_8_R3.entities;" ) );
        }
