...
public class GenClasses {
    ...
    private static final File f = new File( "src/main/java/me/MiniDigger/me.MiniDigger.RideThaMob//v1_9_R1/entities" );
    private static final File orig = new File( new File( "src/main/java/me/MiniDigger/RideThaMob/v1_9_R1" ), "RideAbleEntity.java" );
        ...
        while ( s.hasNextLine() ) {
            w.println( s.nextLine().replace( "EntitySkeleton", "Entity" + file.getName().replace( ".java", "" ).replace( "RideAble", "" ) )
                    .replace( "RideAbleEntity", file.getName().replace( ".java", "" ) ).replace( "%date%", new SimpleDateFormat().format( new Date() ) ).
                            replace( "package me.MiniDigger.RideThaMob.v1_9_R1;", "package me.MiniDigger.RideThaMob.v1_9_R1.entities;" ) );
        }
