...
public abstract class TextualComponent implements Cloneable {
	 ...
	 *
	 * @param playerName
	 *            The name of the player whos score will be shown. If this string represents the single-character
	 ...
	 *
	 * @param selector
	 *            The minecraft player or entity selector which will capture the entities whose string representations
