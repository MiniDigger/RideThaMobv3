...
public abstract class TextualComponent implements Cloneable {
    ...
    private static final class ArbitraryTextTypeComponent extends TextualComponent implements ConfigurationSerializable {
        ...
        public TextualComponent clone() throws CloneNotSupportedException {
            // Since this is a private and final class, we can just reinstantiate this class instead of casting
            // super.clone
        ...
        public Map<String, Object> serialize() {
            return new HashMap<String, Object>() {
                private static final long serialVersionUID = -2640920739644040633L;
    ...
    /**
     * Create a textual component representing a string literal. This is the default type of textual
     * component when a single string literal is given to a method.
     *
     ...
     * overridden by a resource pack. <p> If the specified translation key is not present on the
     * client resource pack, the translation key will be displayed as a string literal to the
     * client. </p>
     *
     ...
     * score for the specified objective as the text represented by this component. <p> <b>This
     * method is currently guaranteed to throw an {@code UnsupportedOperationException} as it is
     ...
     * as it is only supported on snapshot clients.</b> </p>
     *
     * @param playerName          The name of the player whos score will be shown. If this string
     *                            represents the single-character sequence "*", the viewing player's
     *                            score will be displayed. Standard minecraft selectors (@a, @p,
     ...
     * selector as the text represented by this component. <p> <b>This method is currently
     * guaranteed to throw an {@code UnsupportedOperationException} as it is only supported on
     * snapshot clients.</b> </p>
     *
     * @param selector The minecraft player or entity selector which will capture the entities whose
     *                 string representations will be displayed in the place of this text
     *                 component.
